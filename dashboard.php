...
<div class="sidenav">
  <div class="card">
    <div class="card-body">
      <div class="logo">
        <img src="images/onik.jpg" class="profile"/>
    ...
    <section class="row content-header">
      <div class="header-title col-md-11">
        <p class="h4 pt-2"><i class="fa fa-home"></i>&emsp;Dashboard</p>
        &emsp;&emsp;&emsp;<small class="font-weight-bold h6">Home</small>
      </div>
    ...
    <hr style="border-top: 2px solid #ff5252;">
        ...
        <div class="row">
          <div class="row col col-xs-8 col-sm-8 col-md-8 col-lg-8">
                  ...
                  <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4" style="padding: 10px">
                    <div class="dashboard-stats" onclick="location.href='manage_medicine_stock.php?out_of_stock'">
            ...
            <div class="todays-report">
              ...
              <table class="table table-bordered table-striped table-hover">
                <tbody>
                                    <tr>
                                        <th>Total Sales</th>
                    <th class="text-success">TK. 0</th>
                  </tr>
                  <tr>
                                        <th>Total Purchase</th>
                    <th class="text-danger">TK. 0</th>
                  </tr>
                </tbody>
              </table>
            </div>
