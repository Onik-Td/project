      ...
      <div class="container">
        ...
        <div class="row">
          <div class="row col col-xs-12 col-sm-12 col-md-12 col-lg-12">
            ...
            <?php
              ...
              createSection1('manage_medicine.php', 'Total Garments', 'medicines');
             // createSection1('manage_medicine_stock.php?out_of_stock', 'Out of Stock', 'medicines_stock');
              ...
              createSection1('manage_invoice.php', 'Total Invoice', 'invoices');
			        //createSection1('manage_employe.php', 'Total Employe', 'Employe');
              createSection1('manage_contact.php', 'Total Contact', 'contact');
              createSection1('manage_career.php', 'Total Career', 'application_form');
            ?>
        ...
        <!-- <div class="row">
          ...
          <?php
			...
			createSection2('group', 'add_supplier.php', 'onik');
          ?>
