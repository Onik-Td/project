    ...
    <div class="container-fluid">
      <div class="container">
        ...
        <?php
          ...
          createHeader('shopping-bag', 'Manage Garments', '');
        ?>
        <!-- header section end -->
        ...
        <div class="row">
          ...
          <div class="col-md-12 form-group form-inline">
            ...
            <input type="text" class="form-control" id="by_name" placeholder="By Garments Name" onkeyup="searchMedicine(this.value, 'name');">
            	...
            	<table class="table table-bordered table-striped table-hover">
            		<thead>
            			<tr>
            				...
            				<th style="width: 20%;">Garments Name</th>
