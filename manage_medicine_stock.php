...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>Manage Garments Stock</title>
    ...
    <div class="container-fluid">
      <div class="container">
        ...
        <?php
          ...
          createHeader('shopping-bag', 'Manage Garments Stock', '');
        ?>
        <!-- header section end -->
        ...
        <div class="row">
          ...
          <div class="col-md-12 form-group form-inline">
            ...
            <input type="text" class="form-control" id="by_name" placeholder="By Garments Name" onkeyup="searchMedicineStock(this.value, 'NAME');">
            	...
            	<table class="table table-bordered table-striped table-hover">
            		<thead>
            			<tr>
            				...
            				<th style="width: 14%;">Garments Name</th>
